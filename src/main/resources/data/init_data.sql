...
INSERT INTO public.book_comments (id, content, parent, book_detail_id, user_id) VALUES (1, 'A little damage to the back cover, but otherwise great condition.', NULL, 1, 1);
...
INSERT INTO public.book_comments (id, content, parent, book_detail_id, user_id) VALUES (3, 'Explores the emotional baggage we all carry from past relationships - and how it affects present and future relationships, and how important forgiveness is sometimes.  Sad, funny, thoughtful.', NULL, 3, 1);
...
INSERT INTO public.book_comments (id, content, parent, book_detail_id, user_id) VALUES (5, 'excellent condition', NULL, 4, 2);
INSERT INTO public.book_comments (id, content, parent, book_detail_id, user_id) VALUES (6, 'It was a really good book.', NULL, 5, 3);
INSERT INTO public.book_comments (id, content, parent, book_detail_id, user_id) VALUES (7, 'This book is part of the Accelerated Reader program used in many schools across the country.    It is reading level 4.5, worth 5.0 AR points.', NULL, 6, 3);
INSERT INTO public.book_comments (id, content, parent, book_detail_id, user_id) VALUES (8, 'Know a young person? Get them off the street and into a book -- this one''s a great one to get them thinking and using their imagination.', 7, 6, 4);
...
INSERT INTO public.book_comments (id, content, parent, book_detail_id, user_id) VALUES (10, 'This is a great book, For the young and old. My 12 year old daughter enjoyed this book ever so much!!!', NULL, 7, 4);
...
INSERT INTO public.book_comments (id, content, parent, book_detail_id, user_id) VALUES (14, 'good condition. cover is slightly different then the one shown.', NULL, 8, 5);
...
INSERT INTO public.book_comments (id, content, parent, book_detail_id, user_id) VALUES (16, 'Loved the whole series.  Beautiful on the surface...and thought provoking deep within.', 15, 9, 1);
INSERT INTO public.book_comments (id, content, parent, book_detail_id, user_id) VALUES (17, 'A great series.', NULL, 10, 1);
INSERT INTO public.book_comments (id, content, parent, book_detail_id, user_id) VALUES (18, 'My daughters liked this book.', NULL, 11, 1);
INSERT INTO public.book_comments (id, content, parent, book_detail_id, user_id) VALUES (19, 'This is a great series that my 9 year old son and I are reading together.  I had read the adult series and this is interesting to me also.  As it follows along the same story line as the adult books.', NULL, 12, 2);
INSERT INTO public.book_comments (id, content, parent, book_detail_id, user_id) VALUES (20, 'I liked Tiger Ann Parker, the heroine, whose parents are slow, and whose grandmother runs the household.  This is a Young Adult read, although any agegroup will find something to take away from in this book.', NULL, 13, 2);
INSERT INTO public.book_comments (id, content, parent, book_detail_id, user_id) VALUES (21, 'A great book that I read with my bible study group, but can be read at anytime in your life, even if you don''t attend church.', 17, 10, 2);
INSERT INTO public.book_comments (id, content, parent, book_detail_id, user_id) VALUES (22, 'I breezy read, not earth shaking in the least for diffrent for Grisham', NULL, 11, 2);
INSERT INTO public.book_comments (id, content, parent, book_detail_id, user_id) VALUES (23, 'I loved this book.  Grisham is an expert storyteller.  The book was also an excellant tour guide of Italy.', NULL, 12, 3);
INSERT INTO public.book_comments (id, content, parent, book_detail_id, user_id) VALUES (24, 'great book great part of a series', NULL, 13, 3);
